...
from morphomics.utils import tree_type
...
class Neuron(object):
    ...
    from morphomics.Neuron.methods import size
    from morphomics.Neuron.methods import get_bounding_box
