...
class Tree(object):
    ...
    from morphomics.Tree.methods import get_sections_2
    from morphomics.Tree.methods import get_sections_only_points
    from morphomics.Tree.methods import get_segments
    from morphomics.Tree.methods import get_bounding_box
    from morphomics.Tree.methods import get_pca
    from morphomics.Tree.methods import get_type
    from morphomics.Tree.methods import get_direction_between
    from morphomics.Tree.methods import get_point_radial_distances
    from morphomics.Tree.methods import get_point_radial_distances_time
    from morphomics.Tree.methods import get_point_weighted_radial_distances
    from morphomics.Tree.methods import get_point_path_distances
    from morphomics.Tree.methods import get_point_projection
    from morphomics.Tree.methods import get_point_section_lengths
    from morphomics.Tree.methods import get_point_section_branch_orders
    from morphomics.Tree.methods import get_bif_term
    from morphomics.Tree.methods import get_bifurcations
    from morphomics.Tree.methods import get_multifurcations
    from morphomics.Tree.methods import get_terminations

    def __init__(self, x, y, z, d, t, p):
        """Constructor of morphomics Tree Object
